  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed top-8 right-8 z-40 sm:top-6 sm:right-6"
      >
                <motion.button
          onClick={toggleNav}
          className={cn(
        ...
        >
          <div className="px-3 py-1.5 bg-foreground text-background text-xs rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            Navigation
      ...
      <motion.div
        ...
        className="fixed top-20 right-8 z-30 pointer-events-none sm:top-16 sm:right-6"
      >
        <div className="text-xs text-muted-foreground bg-background/50 backdrop-blur-sm px-2 py-1 rounded-md border border-border/50">
