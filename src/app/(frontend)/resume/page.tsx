...
import {
    ...
    Clock,
    CheckCircle2,
    // Add new icons for tech categories
    Palette,
    Database,
    Server,
    Wrench,
...
export default async function ResumePage() {
    ...
    // Add tech category icons mapping
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        {resume.skills.technical.map((category, index) => (
                                            <div key={index} className="space-y-4">
                                                <h4 className="font-semibold text-lg border-b border-border pb-2 flex items-center gap-2">
                                                    {getTechCategoryIcon(category.category)}
                                                    {category.category}
                                                </h4>
                                                <div className="flex flex-wrap gap-2">
                                                    {category.skills?.map((skill, skillIndex) => (
                                                        <Badge key={skillIndex} variant="outline" className="flex items-center gap-1.5">
